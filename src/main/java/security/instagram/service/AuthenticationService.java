...
public class AuthenticationService {
    ...
    public JwtResponse authenticate(LoginRequest request, HttpServletRequest httpServletRequest) {
        ...
        jwtResponse.setUser_name(user.getUserName()); // TODO: THIS IS A BUG
        return jwtResponse;
    }
